...
{
    public class DataIntegrityCheckingFailed: IErrorCondition
    {
        /// <summary>
        ...
        public DataIntegrityCheckingFailed(Enumeration.ErrorCode errorCode, string baseURL, DateTime timeDetected)
        {
            ErrorCode = errorCode;
            BaseURL = baseURL;
