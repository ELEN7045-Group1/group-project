...
{
    public class UnableToCheckDataIntegrity: IErrorCondition
    {
        /// <summary>
        ...
        public UnableToCheckDataIntegrity(Enumeration.ErrorCode errorCode, string baseURL, DateTime timeDetected)
        {
            ErrorCode = errorCode;
            BaseURL = baseURL;
